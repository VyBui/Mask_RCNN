...
class PotholeDataset(utils.Dataset):
    def load_pothole(self, dataset_dir, subset):
        ...
        print ("load annotations from: ", os.path.join(dataset_dir, "via_region_data.json"))
        ...
        for a in annotations:
            ...
            self.add_image(
                "pothole",
                image_id=a['filename'], # use file name as unique id
                path=image_path,
    ...
    def load_mask(self, image_id):
        ...
        """
        # if not pothole class delegate to parent class
